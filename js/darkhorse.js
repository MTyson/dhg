  ...
  "overview": new Page({
    ...
    doPath: function(){
      ...
      if (this.path != null && this.path.length > 1){
		...
		content: [
			{ id: "development", image: "images/programmingdarkhorseweb1.jpg", title: "DEVELOPMENT", subtitle: "CREATE", summary: "Customized solutions that deliver what your projects need, efficiently. Friendly and experienced.", content: "By listening to the desired outcome of every job, we create a dynamic source of energy, focused directly on what you need to realize your vision. <br><h3>Our Team</h3>Our team has specialty in full-stack Java, Node, Python (on the backend), and modern JavaScript frameworks React, Angular and Vue on the front-end.</p> <p>Dark Horse can deliver whatever scale of help you need.  Having delivered successful solutions across a broad range of verticals, we have solid in-house capability and a network of trusted developers we can tap to deliver on requirements." },
